...
export interface ApiBlogPageBlogPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    HeroSection: Schema.Attribute.Component<'sections.hero', true>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiGeneralInfoGeneralInfo extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    branding: Schema.Attribute.Component<'company.branding', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    contacts: Schema.Attribute.Component<'company.contacts', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    legal: Schema.Attribute.Component<'company.legal', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    socialLinks: Schema.Attribute.Component<'company.social-links', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    heroTextBottom: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    aboutUs: Schema.Attribute.Component<'sections.about-us-features', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    projectsTitile: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    services: Schema.Attribute.Component<'sections.service', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    ourServiceDescr: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    fullImage: Schema.Attribute.Media<'images'>;
    ...
    isActive: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    sections: Schema.Attribute.Component<'sections.project-section', true> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    relatedProjects: Schema.Attribute.Relation<
      ...
      'api::project.project'
    >;
    relatedTo: Schema.Attribute.Relation<'manyToMany', 'api::project.project'>;
    tags: Schema.Attribute.Relation<'manyToMany', 'api::tag.tag'>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiSeoSeo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    defaultMetaImage: Schema.Attribute.Media<
